...
export default function ServicesSection() {
  ...
  useLayoutEffect(() => {
    let ctx = gsap.context(() => {
      ...
      // Mobile: Native fast CSS snap layout, clear props
  ...
  return (
    ...
    >
      ...
      {/* Circular Carousel (Desktop) or Fast GPU Snap Slider (Mobile) */}
      <div
        className="relative w-full h-full flex items-center md:justify-center z-10 md:transform-3d overflow-x-auto overflow-y-hidden md:overflow-visible snap-x snap-mandatory scrollbar-hide [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] px-[10vw] md:px-0 gap-5 md:gap-0 touch-pan-x"
